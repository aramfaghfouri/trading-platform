#!/usr/bin/env python3
"""
Simple clean chart that reads from database without developer tools.
"""
import asyncio
import os
import sys
...
class SimpleCleanChart:
    ...
    def _create_chart(self):
        ...
        logger.info("📊 Creating simple clean chart...")
        ...
        logger.info("📈 Simple clean chart created")
    ...
    async def start(self):
        ...
        logger.info("📊 Simple clean chart started!")
        logger.info("🎯 Updating every 10 seconds from database")
    ...
    async def stop(self):
        """Stop the chart."""
        logger.info("🔌 Stopping simple clean chart...")
        self.running = False

async def main():
    chart = SimpleCleanChart()
    try:
        await chart.start()
