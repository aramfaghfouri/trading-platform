#!/usr/bin/env python3
"""
Working live chart that properly handles real-time updates.
"""
import asyncio
import os
import sys
...
class WorkingLiveChart:
    ...
    def _create_chart(self):
        ...
        logger.info("📊 Creating working live chart...")
        ...
        logger.info("📈 Working live chart created")
        ...
        try:
            ...
            if latest_row:
                ...
                if self.last_update_time != time_str:
                    ...
                    current_time = datetime.now(self.est_timezone).strftime('%Y-%m-%d %H:%M:%S')
                    self.chart.topbar.textbox('status', f'Monitoring: {current_time}')
    ...
    async def start(self):
        ...
        logger.info("📊 Working live chart started!")
    ...
    async def stop(self):
        """Stop the chart."""
        logger.info("🔌 Stopping working live chart...")
        self.running = False

async def main():
    chart = WorkingLiveChart()
    try:
        await chart.start()
